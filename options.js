        ...
        <tbody class="divide-y divide-[#d7cfe7] dark:divide-[#332a4a]">
          ${rules.map(rule => `
            <tr class="hover:bg-gray-50/50 dark:hover:bg-[#251b3d]/50 transition-colors ${!rule.isActive ? 'opacity-60 grayscale-[0.5]' : ''}">
              ...
              <td class="px-6 py-5">
                <code class="bg-background-light dark:bg-[#2d2344] px-2 py-1 rounded text-[#5b13ec] dark:text-[#a389d4] text-xs font-mono border border-primary/10">${escapeHtml(rule.findPattern)}</code>
              </td>
              <td class="px-6 py-5">
